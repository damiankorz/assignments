...
input = bI                                    #input variable
if isinstance(input, int):                    #check if input is an interger
    if input >= 100:                          #if yes, check if integer greater than or equal to 100
        print "That's a big number!"          
    else:                                     #if yes but interger is less than 100
        print "That's a small number."
if isinstance(input, str):                    #check if input is a string  
    if len(input) >= 50:                      #if yes, check if charaters are greater than or equal to 50 
        print "Long sentence."
    else:                                     #if yes but characters are less than 50 
        print "Short sentence."
if isinstance(input, list):                   #check if input is a list
    if len(input) >= 10:                      #if yes, check if the length is greater than or equal to 10
        print "Big list!"
    else:                                     #if yes but length is less than 10
        print "Short list."
